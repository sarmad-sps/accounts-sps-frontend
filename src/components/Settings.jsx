...
//     const obj = {};
//     bankKeys.forEach((k) => (obj[k] = String(ob?.[k] ?? 0)));
//     return obj;
//   });
...
//     setBalDraft((prev) => {
//       const next = { ...prev };
//       bankKeys.forEach((k) => (next[k] = String(ob?.[k] ?? 0)));
//       return next;
//     });
//   }, [state?.companyName, state?.openingBalances, bankKeys]);

//   const saveCompanyName = () => {
//     actions.setCompanyName(nameDraft);
//     setEditingName(false);
//   };

//   const saveOpeningFor = (bankKey) => {
//     actions.setOpeningBalance(bankKey, balDraft[bankKey]);
//   };

//   const saveAllOpenings = () => {
//     BANKS.forEach((b) => actions.setOpeningBalance(b.key, balDraft[b.key]));
//   };
...
//                 Changes will be saved to database automatically.
//               </div>
//             </div>
//           )}
//         </div>
...
//                 Set initial balances for each bank account
//               </div>
//             </div>
...
//             {BANKS.map((b) => (
//               <div key={b.key} style={styles.bankCard}>
...
//                     Saved: <strong>{state?.openingBalances?.[b.key] ?? 0}</strong>
//                   </div>
//                   <button
//                     style={styles.smallBtn}
...
//             Note: These values are used as starting balances and persist after refresh.
//           </div>
//         </div>
//       </div>
//     </div>
...
// // Responsive adjustment (optional - can be in useEffect or CSS media query)
// if (typeof window !== "undefined" && window.innerWidth < 900) {
//   styles.grid.gridTemplateColumns = "1fr";
//   styles.bankGrid.gridTemplateColumns = "1fr";
// }
