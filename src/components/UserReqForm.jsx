...
//     receivedQty: "",
//     paymentMethod: "Cash",
//     bank: (BANKS && BANKS[0] && BANKS[0].key) || "",
//     paymentStatus: "Paid",
//     amount: "",
//   });
...
//         receivedQty: "",
//         paymentMethod: "Cash",
//         bank: (BANKS && BANKS[0] && BANKS[0].key) || "BANK_ISLAMI",
//         paymentStatus: "Paid",
//         amount: "",
//       });
//       fetchRequests();
...
//     if (role === "store")
//       return ["pending_store", "stock_received"].includes(r.status);
//     if (role === "admin")
//       return ["needs_purchase", "pending_admin", "purchase_approved"].includes(
//         r.status,
//       );
...
//                     .filter((r) => {
//                       if (role === "store")
//                         return ["pending_store", "stock_received"].includes(
//                           r.status,
//                         );
//                       if (role === "admin")
//                         return [
...
//                         ].includes(r.status);
//                       if (role === "accountant")
//                         return r.status === "purchase_approved";
//                       return false;
//                     })
//                     .map((req) => (
...
//                       }}
//                     >
//                       {new Date(req.createdAt || req.date).toLocaleString(
//                         "en-PK",
...
//                           <button
//                             onClick={() =>
//                               handleAction(req._id, "send_to_admin")
//                             }
//                             style={
//                               (req.stock ?? 0) >= req.qty
//                                 ? btnApprove
...
//                         <button
//                           onClick={() =>
//                             handleAction(req._id, "purchase_approved")
//                           }
//                           style={btnApprove}
//                         >
//                           Approve Purchase
...
//                       {/* Accountant */}
//                       {role === "accountant" &&
//                         req.status === "purchase_approved" && (
//                           <button
//                             onClick={() => setReceiptModal(req)}
//                             style={btnApprove}
//                           >
//                             Enter Receipt
//                           </button>
...
//                         (req.stock ?? 0) >= req.qty && (
//                           <button
//                             onClick={() => handleAction(req._id, "issued")}
//                             style={btnIssue}
//                           >
//                             Issue Item
//                           </button>
...
//                           bank: method === "Cash" ? null : receiptData.bank,
//                         });
//                       }}
//                     >
//                       {BANKS.map((b) => (
...
//                 onClick={() => handleReceiptSave(receiptModal._id)}
//               >
//                 Confirm & Save
//               </button>
//             </div>
...
// };
// const slipItemDataRow = {
//   padding: "18px 20px",
//   display: "flex",
//   fontSize: "15px",
// };
// const slipSignaturesArea = {
//   display: "flex",
//   justifyContent: "space-between",
//   gap: "24px",
//   marginTop: "60px",
          ...
          <table style={tableStyle}>
            ...
            <tbody>
              {requests.map((req) => (
                <tr key={req._id} style={trStyle}>
                  <td style={tdStyle}>
                    <div style={{ fontSize: "clamp(12px, 3.2vw, 14px)" }}>
                  ...
                  <td style={tdStyle}>
                    <span
                      style={{
                        ...
                        fontWeight: 600,
                        backgroundColor:
                          (req.stock ?? 0) >= req.qty ? "#d1fae5" : "#fee2e2",
                        color:
                          (req.stock ?? 0) >= req.qty ? "#065f46" : "#991b1b",
                      }}
                    >
                      {req.stock != null ? req.stock : "N/A"}
                    </span>
                  </td>
                  <td style={tdStyle}>{getStatusBadge(req.status)}</td>
                  <td style={actionTd}>
                    <div style={actionGroup}>
                      ...
                      {role === "store" && req.status === "pending_store" && (
                        <button
                          onClick={() => handleAction(req._id, "send_to_admin")}
                          style={
                            (req.stock ?? 0) >= req.qty ? btnApprove : btnVerify
                          }
                        >
                          {(req.stock ?? 0) >= req.qty
                            ? "Stock In"
...
const formGrid = {
  display: "grid",
  gridTemplateColumns:
    "repeat(auto-fit, minmax(clamp(200px, 100%, 240px), 1fr))",
