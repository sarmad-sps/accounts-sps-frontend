...
const styles = {
  ...
  title: { fontSize: 32, fontWeight: 800, margin: 0, color: "#0f172a", letterSpacing: "-1px" },
  summary: { fontSize: 15, color: "#64748b", marginTop: 6, fontWeight: "500" },
  ...
  cardTitle: { fontSize: 22, fontWeight: 700, margin: "0 0 24px 0", color: "#0f172a" },
  label: {
    fontSize: 13,
    fontWeight: "700",
    color: "black",
  ...
  formGrid2: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24 },
  formGrid3: {
    display: "grid",
  ...
  otherCategory: { margin: "20px 0" },
  formActions: { marginTop: 36, textAlign: "right" },
  submitBtn: {
    padding: "13px 40px",
    background: "#3b82f6", 
    color: "white",
  ...
  trackerInfo: { fontSize: 13, color: "#64748b", marginTop: 6, lineHeight: 1.5 },
  agentInfo: { fontSize: 13, fontWeight: "600", marginTop: 6, color: "#3b82f6" },
  actionButtons: {
    display: "flex",
    flexWrap: "nowrap",
    gap: 8,
