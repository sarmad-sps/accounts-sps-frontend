...
//   const openingByBank = state.openingBalances || { BANK_ISLAMI: 0, HBL: 0 };

//   const receivedByBank = { BANK_ISLAMI: 0, HBL: 0 };
//   const paidByBank = { BANK_ISLAMI: 0, HBL: 0 };
//   const pendingReceivable = {};

//   for (const r of state.receivings || []) {
//     const bank = r.bank || "BANK_ISLAMI";
//     const amt = Number(r.amount) || 0;
//     if (r.status === "RECEIVED") receivedByBank[bank] = (receivedByBank[bank] || 0) + amt;
//     else pendingReceivable[r.party] = (pendingReceivable[r.party] || 0) + amt;
//   }
